...
export default function Footer() {
  return (
    <>
    <footer className="bg-white shadow-lg dark:bg-gray-800 border-2 border-gray-50 dark:border-gray-700">
        ...
        <div className="py-16">
          ...
          <nav className="my-10 text-sm" aria-label="quick-links">
            <div className="flex justify-center gap-x-6 mb-6">
              <div className="dark:text-white cursor-pointer" onClick={() => window.open("https://www.linkedin.com/in/hardik-daim-ab0b07251/")}>About Creator</div>
              <div className="dark:text-white cursor-pointer" onClick={() => window.open("https://hardikdaim.netlify.app")}>Creator's Website</div>
              <div className="dark:text-white cursor-pointer" onClick={() => window.open("https://github.com/HardikDaim")}>GitHub Profile</div>
            </div>
            <div className="flex justify-center dark:text-white select-none"><span>Copyright © {new Date().getFullYear()} Made by <b>Hardik Daim</b></span></div>
          </nav>
        </div>
